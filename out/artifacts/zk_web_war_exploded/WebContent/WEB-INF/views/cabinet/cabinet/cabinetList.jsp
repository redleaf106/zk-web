...
<div class="pageHeader">
	...
	<div class="searchBar">
		...
		<a class="button" href="${ctx}/cabinet/cabinet/getCabinetInfo" target="dialog" rel="dlg_page11" mask="true">
			<span>模态框</span>
		</a>
	</div>
	</form>
				...
				<c:forEach var="item" items="${cabinetPage.data}" varStatus="serial">
					<tr target="sid_cabinet" rel="${item.id}">
						...
						<td>&nbsp;
							...
							<a title="查看使用状态" href="${ctx}/cabinet/cabinet/toEditFormPage/${item.id}" class="btnLook" target="navTab">查看</a>
